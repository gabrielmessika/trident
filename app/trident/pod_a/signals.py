...
class AnchorTrendContext:
    ...
    current_4h_sample_count: int = 0
    chart_pattern_name: str = ""
    chart_pattern_validation_time: str = ""
    chart_pattern_theoretical_target_bps: float = 0.0
    chart_pattern_structure_height_pct: float = 0.0
    chart_pattern_structure_depth_pct: float = 0.0
    chart_pattern_breakout_margin_pct: float = 0.0
    chart_pattern_compression_pct: float = 0.0
    chart_pattern_low_mismatch_pct: float = 0.0
    chart_pattern_upper_slope_pct_per_bar: float = 0.0
    chart_pattern_lower_slope_pct_per_bar: float = 0.0
    chart_pattern_bars: int = 0
