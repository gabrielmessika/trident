...
class LiveSnapshotBuilderTests(unittest.TestCase):
    ...
    def test_builder_tracks_feature_deltas_across_buckets(self) -> None:
        ...
        self.assertAlmostEqual(btc["bid_depth_velocity"], 1.0, places=4)
        self.assertAlmostEqual(btc["ask_depth_velocity"], -0.5, places=4)
        self.assertAlmostEqual(btc["best_bid_size_velocity"], 1.0, places=4)
        self.assertAlmostEqual(btc["best_ask_size_velocity"], -0.5, places=4)
