...
class SettingsConfigTests(unittest.TestCase):
    def test_mainnet_config_keeps_live_safety_defaults(self) -> None:
        ...
        self.assertFalse(config.pod_a.dynamic_symbol_guard_recovery_sizing_enabled)
        self.assertEqual(config.pod_a.dynamic_symbol_guard_recovery_base_multiplier, 0.70)
        self.assertEqual(config.pod_a.dynamic_symbol_guard_recovery_partial_multiplier, 0.85)
        ...
        self.assertTrue(config.pod_a.dynamic_symbol_guard_loss_probation_sizing_enabled)
        ...
        self.assertTrue(config.pod_c.external_reference_fresh_cap_sizing_enabled)
        self.assertEqual(
