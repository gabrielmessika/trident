...
- [x] **P1-09 — Recherche factorielle from scratch multi-coins/timeframes**
  ...
  **Mise à jour HIP-4 2026-06-18** : review `server-data/hip4/reviews/20260618T074806Z/hip4_outcome_run_review.md` = `collect_more_data` ; total PF `1.0248/1.15`, paper `49` trades / `47` settlements, PnL `+6.2836`, Brier `0.2300`, observer `0` trade. L'audit policy `server-data/hip4/replay_reports/hip4_policy_market_audit_20260618T074556Z.md` est positif post-cutoff (`active_paper` `25` settlements `+40.7368`, PF `1.3973`; `prob_stop_full` `+43.2741`, PF `1.4328`) mais reste trop court et sans confirmation observer. Verdict inchangé : pas de promotion mainnet HIP-4.
